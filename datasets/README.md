...
| [payment_refund_events_v1](./payment_refund_events_v1.md) | `37` | Refund/cancel event-level dataset на grain `order_id + payment_id + refund_id` |
| [order_payment_net_v1](./order_payment_net_v1.md) | `39` | Payment-level gross/refund/net dataset на grain `order_id + payment_id` |
| [payment_campaign_net_attribution_v1](./payment_campaign_net_attribution_v1.md) | `38` | Campaign net attribution с наследованием bucket исходной оплаты |
